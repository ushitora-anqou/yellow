...
public:
    ...
    bool statusUpdate(const std::string& newStatus /* in */,
                      const std::string inReplyToStatusId = "" /* in */);
    ...
    /* Twitter user APIs */
    bool userLookup(const std::vector<std::string>& userInfo /* in */,
                    const bool isUserId = false /* in */);
    bool userGet(const std::string& userInfo /* in */,
                 const bool isUserId = false /* in */);
    bool friendsGet(const std::string userInfo = "" /* in */,
                    const bool isUserId = false /* in */);
    bool followersGet(const std::string userInfo = "" /* in */,
                      const bool isUserId = false /* in */);

    /* Twitter direct message APIs */
    bool directMessageGet(const std::string sinceId = "" /* in */);
    bool directMessageSend(const std::string& userInfo /* in */,
                           const std::string& dMsg /* in */,
                           const bool isUserId = false /* in */);
    bool directMessageGetSent();
    bool directMessageDestroyById(const std::string& dMsgId /* in */);

    /* Twitter friendships APIs */
    bool friendshipCreate(const std::string& userInfo /* in */,
                          const bool isUserId = false /* in */);
    bool friendshipDestroy(const std::string& userInfo /* in */,
                           const bool isUserId = false /* in */);
    bool friendshipShow(const std::string& userInfo /* in */,
                        const bool isUserId = false /* in */);
    ...
    bool blockIdsGet(const std::string& nextCursor /* in */,
                     const bool stringifyIds /* in */);
    ...
    void usertimeline(std::function<void(const std::string&)> func);
...
private:
    ...
    /* Internal cURL related methods */
    static int curlCallback(char* data, size_t size, size_t nmemb,
                            twitCurl* pTwitCurlObj);
};

/* Private functions */
void utilMakeCurlParams(std::string& outStr, const std::string& inParam1,
                        const std::string& inParam2);
void utilMakeUrlForUser(std::string& outUrl, const std::string& baseUrl,
                        const std::string& userInfo, const bool isUserId);
